...
| 3 | Using Defender for Endpoint to create Endpoint security policies | [View section](#3-Using-Defender-for-Endpoint-to-create-Endpoint-security-policies) | View incident report |
